...
&lt;/div&gt;
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-center">
        ...
        <a target="_blank" href="https://shop.zundel-webdesign.de/laravel-bootstrap-components-incl-themes" class="btn btn-primary btn-lg shadow" style="margin-bottom:100px">
          Purchase Themes
        </a>
      </div>
    </div>
